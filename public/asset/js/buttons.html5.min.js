            ...
            action: function (t, e, o, l) {
                ...
                if (y.queryCommandSupported("copy")) {
                    ...
                    try {
                        ...
                        if ((i.remove(), s))
                            return (
                                e.buttons.info(e.i18n("buttons.copyTitle", "Copy to clipboard"), e.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, r.rows), 2e3), void this.processing(!1)
                            );
                    } catch (t) {}
                }
                function f() {
            ...
            action: function (t, e, o, s) {
                        ...
                        (n =
                            ...
                            ("number" == typeof t[e] || (t[e].match && t[e].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) && !t[e].match(/^0\d+/))
                                ...
                                : ((r = r.replace ? r.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : r),
                                  E(u, "c", { attr: { t: "inlineStr", r: l }, children: { row: E(u, "is", { children: { row: E(u, "t", { text: r, attr: { "xml:space": "preserve" } }) } }) } })))),
                            m.appendChild(n);
                    }
                    c.appendChild(m), y++;
                }
                ...
                var a,
                    ...
                    p = {
                        ...
                        xl: { _rels: { "workbook.xml.rels": l("xl/_rels/workbook.xml.rels") }, "workbook.xml": l("xl/workbook.xml"), "styles.xml": l("xl/styles.xml"), worksheets: { "sheet1.xml": u } },
                                ...
                                width: (function (t, e) {
                                    ...
                                    for (var l = 0, n = t.body.length; l < n; l++) {
                                        ...
                                        if (
                                            ...
                                            (o =
                                                o <
                                                (r = (-1 !== (a = null !== a && a !== k ? a.toString() : "").indexOf("\n")
                                                    ? ((r = a.split("\n")).sort(function (t, e) {
                ...
                C("sheets sheet", w).attr("name", N(s)),
                    s.autoFilter &&
                        ...
                        C("definedNames", w).append(E(w, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: N(s) + "!$A$" + F + ":" + z(i.header.length - 1) + a }))),
                                ...
                                C.each(t, function (t, e) {
                                    if (C.isPlainObject(e)) s(f.folder(t), e);
                                        ...
                                        var i = A.serializeToString(e),
                                            i = (i = D
                                                ? (i = (i = -1 === i.indexOf("<?xml") ? '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + i : i).replace(/_dt_b_namespace_token_/g, ":")).replace(/xmlns:NS[\d]+="" NS[\d]+:/g, "")
