...
<section class="third-header menulist-details">
               ...
               <div class="grid-two align-items-center">
                  <div class="list-det">
                     <ul class="d-flex gap-3">
                        <li><a data-bs-toggle="modal" data-bs-target="#add_harddisk_name_model" class="btn btn-white"><img src="{{basepath('images/plus-sign.svg')}}" alt="plus-sign"> Add Graphic card</a></li>
                     </ul>
                  </div>
      ...
      <section class="content-area table-section">
         ...
         <div class="filter-section">
            ...
            <h2 class="mb-0">Graphic Card</h2>
         </div>
      
            <!-- filter list tab section start end -->
            <div class="tab-content1" id="pills-tabContent">
               <table id="graphiccard_list_data" class="display device_list_data tabledesignmain" style="width: 100%;">
                  <thead>
                     <tr>
      ...
      <!-- Content area end  -->
<!--  Keyboard popup--> 
<div class="modal mymodel add_accessories_name_model fade" id="add_harddisk_name_model" tabindex="-1" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
 <div class="form-content">
    <h5 class="modal-title">Add Accessories (Graphic Card)</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
 </div>
 <div class="form-body">
    <form method="post" action="{{Route('graphiccard.save')}}" enctype="multipart/form-data">
      @csrf
         <div class="field-set">
               ...
               <div class="d-grid gap-3">                      
                     <div class="row">
                        <div class="col-lg-6 pe-0">
                           <div class="form-re">
                                 <input type="text" required name="brand" class="my-from-control" id="yourname" value="" placeholder="Enter Brand Name">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-re">
                                 <input type="text" required name="configuration" id="mobile_code1" class="my-from-control" value="" placeholder="Enter Configuration">
                           </div>
                        </div>
                     </div>                       
                     <div class="row">
                        <div class="col-lg-6 pe-0">
                           <div class="form-re">
                                 <input type="text" required name="serial_no" id="mobile_code2" class="my-from-control " placeholder="Enter Product Serial No. ">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-re">
                                 <select class="my-from-control selectcol course" required name="status" id="" aria-label="Default select example" style="width: 100%;">
            ...
            <fieldset class="form-border rounded-3 p-3 text-start upload-img-box">
               ...
               <div class="d-grid gap-3">                      
                     <div class="row">
                        <div class="col-lg-6 pe-0">
                           <div class="form-re">
                                 <input type="text" required name="invoice_no" class="my-from-control" id="yourname" value="" placeholder="Enter Invoice No.">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-re">   
                              <input type="date" required name="invoice_date" value="" class="my-from-control" placeholder="Enter Invoice Date" required="">
                           </div>
                        </div>
                     </div>   
                     <div class="form-re">
                        <input type="text" required name="invoice_company_name" class="my-from-control" id="yourname" value="" placeholder="Enter Invoice Company Name">
                     </div>  
                     <div class="form-re">   
                        <input type="date" required name="warranty_end" value="" class="my-from-control" placeholder="Warranty End Date" required="">
                     </div>             
...
//       });
      ...
      var laptop=$("#graphiccard_list_data").DataTable({
            "serverSide" : true,
            "processing" : true,
            lengthMenu: [
                [ 10, 25, 50, -1 ],
