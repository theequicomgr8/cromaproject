...
<section class="third-header menulist-details">
               ...
               <div class="grid-two align-items-center">
                  <div class="list-det">
                     <ul class="d-flex gap-3">
                        <li><a data-bs-toggle="modal" data-bs-target="#add_mouse_name_model" class="btn btn-white"><img src="{{basepath('images/plus-sign.svg')}}" alt="plus-sign"> Add Mouse</a></li>
                     </ul>
                  </div>
      ...
      <section class="content-area table-section">
         ...
         <div class="filter-section">
            ...
            <h2 class="mb-0">Mouse</h2>
         </div>
      
            <!-- filter list tab section start end -->
            <div class="tab-content1" id="pills-tabContent">
               <table id="mouse_list_data" class="display device_list_data tabledesignmain" style="width: 100%;">
                  <thead>
                     <tr>
 ...
 <!-- Mouse Add Modal start -->
<div class="modal mymodel add_accessories_name_model fade" id="add_mouse_name_model" tabindex="-1" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
 <div class="form-content">
    <h5 class="modal-title">Add Accessories (Mouse)</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
 </div>
 <div class="form-body">
    <form method="post" action="{{Route('mouse.save')}}" enctype="multipart/form-data">
      @csrf
         <div class="field-set">
         ...
         <div class="field-set mt-2">
            <fieldset class="form-border rounded-3 p-3 text-start upload-img-box">
               ...
               <div class="d-grid gap-3">                      
                     ...
                     <div class="form-re">   
                        <input type="date" name="warranty_end" required value="" class="my-from-control" placeholder="Warranty End Date" required="">
                     </div>             
...
//       });
      ...
      var laptop=$("#mouse_list_data").DataTable({
            "serverSide" : true,
            "processing" : true,
            lengthMenu: [
                [ 10, 25, 50, -1 ],
