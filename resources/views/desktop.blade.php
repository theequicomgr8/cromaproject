...
<section class="third-header menulist-details">
               ...
               <div class="grid-two align-items-center">
                  <div class="list-det">
                     <ul class="d-flex gap-3">
                        <li><a data-bs-toggle="modal" data-bs-target="#add_desktop_name_model" class="btn btn-white"><img src="{{basepath('images/plus-sign.svg')}}" alt="plus-sign"> Add Desktop</a></li>
                     </ul>
                  </div>
      ...
      <section class="content-area table-section">
         ...
         <div class="filter-section">
            ...
            <h2 class="mb-0">Desktop</h2>
         </div>
      
            <!-- filter list tab section start end -->
            <div class="tab-content1" id="pills-tabContent">
               <table id="desktop_list_data" class="display device_list_data tabledesignmain" style="width: 100%;">
                  <thead>
                     <tr>
...
//       });
      ...
      var laptop=$("#desktop_list_data").DataTable({
            "serverSide" : true,
            "processing" : true,
            lengthMenu: [
                [ 10, 25, 50, -1 ],
