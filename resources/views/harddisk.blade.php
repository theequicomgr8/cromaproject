...
<section class="third-header menulist-details">
               ...
               <div class="grid-two align-items-center">
                  <div class="list-det">
                     <ul class="d-flex gap-3">
                        <li><a data-bs-toggle="modal" data-bs-target="#add_harddisk_name_model" class="btn btn-white"><img src="{{basepath('images/plus-sign.svg')}}" alt="plus-sign"> Add Harddisk</a></li>
                     </ul>
                  </div>
      ...
      <section class="content-area table-section">
         ...
         <div class="filter-section">
            ...
            <h2 class="mb-0">Harddisk</h2>
         </div>
      
            <!-- filter list tab section start end -->
            <div class="tab-content1" id="pills-tabContent">
               <table id="harddisk_list_data" class="display device_list_data tabledesignmain" style="width: 100%;">
                  <thead>
                     <tr>
...
<div class="modal-content">
 <div class="form-content">
    <h5 class="modal-title">Add Accessories (Harddisk)</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
 </div>
 <div class="form-body">
    <form method="post" action="{{Route('harddisk.save')}}" enctype="multipart/form-data">
      @csrf
         <div class="field-set">
...
//       });
      ...
      var laptop=$("#harddisk_list_data").DataTable({
            "serverSide" : true,
            "processing" : true,
            lengthMenu: [
                [ 10, 25, 50, -1 ],
